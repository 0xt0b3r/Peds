...
for	i=1, #Config.Locations2, 1 do
	Config.Zones['Nightclubs_' .. i] = {
		Pos   = Config.Locations2[i]
	}
end

for	i=1, #Config.Locations3, 1 do
	Config.Zones['Nightclubs_' .. i] = {
		Pos   = Config.Locations3[i]
	}
end

for	i=1, #Config.Locations4, 1 do
	Config.Zones['Nightclubs_' .. i] = {
		Pos   = Config.Locations4[i]
	}
end

for	i=1, #Config.Locations5, 1 do
	Config.Zones['Nightclubs_' .. i] = {
		Pos   = Config.Locations5[i]
	}
end

for	i=1, #Config.Locations6, 1 do
	Config.Zones['Nightclubs_' .. i] = {
		Pos   = Config.Locations6[i]
	}
end

for	i=1, #Config.Locations7, 1 do
	Config.Zones['Nightclubs_' .. i] = {
		Pos   = Config.Locations7[i]
	}
end

for	i=1, #Config.Locations8, 1 do
	Config.Zones['Nightclubs_' .. i] = {
		Pos   = Config.Locations8[i]
	}
end

for	i=1, #Config.Locations9, 1 do
	Config.Zones['Nightclubs_' .. i] = {
		Pos   = Config.Locations9[i]
	}
end

for	i=1, #Config.Locations10, 1 do
	Config.Zones['Nightclubs_' .. i] = {
		Pos   = Config.Locations10[i]
	}
end

for	i=1, #Config.Locations11, 1 do
	Config.Zones['Nightclubs_' .. i] = {
		Pos   = Config.Locations11[i]
	}
end

for	i=1, #Config.Locations12, 1 do
	Config.Zones['Solomun_' .. i] = {
		Pos   = Config.Locations12[i]
	}
end

for	i=1, #Config.Locations13, 1 do
	Config.Zones['Dixon_' .. i] = {
		Pos   = Config.Locations13[i]
	}
end

for	i=1, #Config.Locations14, 1 do
	Config.Zones['Drugs_' .. i] = {
		Pos   = Config.Locations14[i]
	}
end

for	i=1, #Config.Locations15, 1 do
	Config.Zones['Drugs_' .. i] = {
		Pos   = Config.Locations15[i]
	}
end

for	i=1, #Config.Locations16, 1 do
	Config.Zones['Drugs_' .. i] = {
		Pos   = Config.Locations16[i]
	}
end

for	i=1, #Config.Locations17, 1 do
	Config.Zones['Drugs_' .. i] = {
		Pos   = Config.Locations17[i]
	}
end

for	i=1, #Config.Locations18, 1 do
	Config.Zones['Drugs_' .. i] = {
		Pos   = Config.Locations18[i]
	}
end

for	i=1, #Config.Locations19, 1 do
	Config.Zones['Cops_' .. i] = {
		Pos   = Config.Locations19[i]
	}
end

for	i=1, #Config.Locations20, 1 do
	Config.Zones['Cops_' .. i] = {
		Pos   = Config.Locations20[i]
	}
end

for	i=1, #Config.Locations21, 1 do
	Config.Zones['Cops_' .. i] = {
		Pos   = Config.Locations21[i]
	}
end

for	i=1, #Config.Locations22, 1 do
	Config.Zones['Weapons_' .. i] = {
		Pos   = Config.Locations22[i]
	}
end
