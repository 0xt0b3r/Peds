--Config.Locations = { -- Bahama Pos
	--{ x = -1395.22,   y = -603.95, z = 29.32, heading = 76.72 },	-- Bahama1
	--{ x = -1400.22,   y = -602.95, z = 29.32, heading = 259.92 },	-- Bahama2
	--{ x = -1403.88,   y = -605.39, z = 29.32, heading = 317.34 },	-- Bahama3
	--{ x = -1399.00,   y = -610.40, z = 29.32, heading = 317.11 },	-- Bahama4
	--{ x = -1390.22,   y = -616.75, z = 29.82, heading = 260.23 },	-- BahamaDanceFloor1
	--{ x = -1385.28,   y = -623.33, z = 29.82, heading = 16.56 },	-- BahamaDanceFloor2
	--{ x = -1375.20,   y = -624.75, z = 29.82, heading = 76.72 }	-- Bahama5
--}
...
--Nightclub--
Config.EnableNightclubs = true   -- If true spawn Nightclub NPCs (Need a IPL Loader https://github.com/Bob74/bob74_ipl or other)
...
Config.Locations1 = { -- Some Shop & Interior NPCs
	{ x = 241.06,   y = -1378.91, z = 32.74, heading = 148.29 },	-- esx_dmvschool
	{ x = 262.43,   y = -1360.00, z = 23.55, heading = 47.16 },    -- Central Hospital Main
	{ x = 265.91,   y = -1358.64, z = 23.55, heading = 316.29 },    -- Central Hospital Main 2
	{ x = 440.85,   y = -978.41,  z = 29.69, heading = 165.95 },    -- PD Main Welcome
	{ x = 458.97,   y = -1017.28, z = 27.16, heading = 93.49 },    -- PD Main Garage
	{ x = -1117.15, y = -503.20,  z = 34.81, heading = 294.47 },    -- Moneywash Moveact
	...
	{ x = 1224.68,  y = 2728.74,  z = 37.01, heading = 178.83 }    -- Cardealer2
}

------------------------------------NIGHTCLUBS-------------------------------------
Config.Locations2 = { -- Nightclub Girls1
	{ x = -1593.89,   y = -3008.52, z = -80.01, heading = 209.23 },	-- NClub1
	{ x = -1587.04,   y = -3005.37, z = -80.01, heading = 137.56 },	-- NClub2
	{ x = -1576.61,   y = -3014.49, z = -80.01, heading = 168.78 },	-- NClub3
	{ x = -1590.54,   y = -3018.24, z = -77.00, heading = 317.11 },	-- NClub4
	{ x = -1585.82,   y = -3008.32, z = -77.00, heading = 218.73 },	-- NClub5
